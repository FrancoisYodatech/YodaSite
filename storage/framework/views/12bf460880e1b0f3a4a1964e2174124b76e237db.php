...
<?php $__env->startSection('h1'); ?>
  Ceci est l'article numéro <?php echo e($numero); ?>
...
<?php $__env->startSection('redirect'); ?>
  <a class="btn btn-primary" href="https://yodasite.app/facture/<?php echo e($numero); ?>">La facture du meme Numéro</a>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('template1', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>